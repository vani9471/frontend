...
const MockExamPage = () => {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                if (currentSub) {
                    ...
                    const examRes = await axios.get(`${import.meta.env.VITE_API_URL || (import.meta.env.DEV ? 'http://localhost:5000' : 'https://backend-1-x7ra.onrender.com')}/api/mock-exams?subject=${currentSub._id}`);
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            await axios.post(`${import.meta.env.VITE_API_URL || (import.meta.env.DEV ? 'http://localhost:5000' : 'https://backend-1-x7ra.onrender.com')}/api/mock-exams/${examId}/submit`, resultData);
