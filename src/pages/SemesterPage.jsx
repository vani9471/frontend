...
const SemesterPage = () => {
    ...
    useEffect(() => {
        const fetchSubjects = async () => {
            setLoading(true);
            try {
                const res = await axios.get(`${import.meta.env.VITE_API_URL || (import.meta.env.DEV ? 'http://localhost:5000' : 'https://backend-1-x7ra.onrender.com')}/api/subjects?regulation=${reg.toUpperCase()}&semester=${semesterNumber}`);
